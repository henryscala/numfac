...
$pyjs.loaded_modules['binascii'] = function (__mod_name__) {
	...
	$m['a2b_uu'] = function(s) {
		...
		length = (typeof ($mod1=(typeof ($sub1=$p['ord']((typeof ($1=s).__array != 'undefined'?
			((typeof $1.__array[$2=0]) != 'undefined'?$1.__array[$2]:
				$1.__getitem__($2)):
				$1.__getitem__(0))))==typeof ($sub2=32) && (typeof $sub1=='number'||typeof $sub1=='string')?
			$sub1-$sub2:
			$p['op_sub']($sub1,$sub2)))==typeof ($mod2=64) && typeof $mod1=='number'?
	...
	$listcomp1 = $p['list']();
			...
			while (typeof ($iter1_nextval=($iter1_type?($iter1_type > 0?$iter1_iter.next(true,true):$p['wrapped_next']($iter1_iter)):$iter1_array[$iter1_idx++])) != 'undefined') {
				...
				$listcomp1['append'](''['join']($p['list']([$p['chr']((((typeof ($sub3=A)==typeof ($sub4=32) && (typeof $sub3=='number'||typeof $sub3=='string')?
					$sub3-$sub4:
					$p['op_sub']($sub3,$sub4)))<<(2))|((((typeof ($sub5=B)==typeof ($sub6=32) && (typeof $sub5=='number'||typeof $sub5=='string')?
					$sub5-$sub6:
					$p['op_sub']($sub5,$sub6)))>>(4))&(3))), $p['chr'](((((typeof ($sub7=B)==typeof ($sub8=32) && (typeof $sub7=='number'||typeof $sub7=='string')?
					$sub7-$sub8:
					$p['op_sub']($sub7,$sub8)))&(15))<<(4))|((((typeof ($sub9=C)==typeof ($sub10=32) && (typeof $sub9=='number'||typeof $sub9=='string')?
					$sub9-$sub10:
					$p['op_sub']($sub9,$sub10)))>>(2))&(15))), $p['chr'](((((typeof ($sub11=C)==typeof ($sub12=32) && (typeof $sub11=='number'||typeof $sub11=='string')?
					$sub11-$sub12:
					$p['op_sub']($sub11,$sub12)))&(3))<<(6))|(((typeof ($sub13=D)==typeof ($sub14=32) && (typeof $sub13=='number'||typeof $sub13=='string')?
					$sub13-$sub14:
					$p['op_sub']($sub13,$sub14)))&(63)))])));
			}
				...
				(typeof $bool5=='object'?
					(typeof $bool5.__nonzero__=='function'?
						...
						(typeof $bool5.__len__=='function'?
							...
							true ) ) :
					 true ) )) {
			result = (typeof ($add3=result)==typeof ($add4=(typeof ($mul1=(typeof ($sub15=length)==typeof ($sub16=(($len2=result) === null?0:
	...
	$listcomp2 = $p['list']();
		...
		while (typeof ($iter2_nextval=($iter2_type?($iter2_type > 0?$iter2_iter.next(true,true):$p['wrapped_next']($iter2_iter)):$iter2_array[$iter2_idx++])) != 'undefined') {
			...
			$listcomp2['append'](''['join']($p['list']([$p['chr']((typeof ($add7=32)==typeof ($add8=((A)>>(2))&(63)) && (typeof $add7=='number'||typeof $add7=='string')?
				$add7+$add8:
				$p['op_add']($add7,$add8))), $p['chr']((typeof ($add9=32)==typeof ($add10=(((A)<<(4))|(((B)>>(4))&(15)))&(63)) && (typeof $add9=='number'||typeof $add9=='string')?
				$add9+$add10:
				$p['op_add']($add9,$add10))), $p['chr']((typeof ($add11=32)==typeof ($add12=(((B)<<(2))|(((C)>>(6))&(3)))&(63)) && (typeof $add11=='number'||typeof $add11=='string')?
				$add11+$add12:
				$p['op_add']($add11,$add12))), $p['chr']((typeof ($add13=32)==typeof ($add14=(C)&(63)) && (typeof $add13=='number'||typeof $add13=='string')?
				$add13+$add14:
				$p['op_add']($add13,$add14)))])));
		}

	return $listcomp2;}();
		return (typeof ($add19=(typeof ($add17=$p['chr']((typeof ($add15=$p['ord'](' '))==typeof ($add16=(length)&(63)) && (typeof $add15=='number'||typeof $add15=='string')?
			$add15+$add16:
			$p['op_add']($add15,$add16))))==typeof ($add18=''['join'](result)) && (typeof $add17=='number'||typeof $add17=='string')?
			$add17+$add18:
			$p['op_add']($add17,$add18)))==typeof ($add20='\x0A') && (typeof $add19=='number'||typeof $add19=='string')?
			$add19+$add20:
	...
	$m['a2b_base64'] = function(s) {
		var $eq9,$bool18,$sub20,$bool19,$sub19,$bool12,leftchar,$bool14,$bool15,$bool16,$bool17,$or6,$iter4_type,$eq11,$eq10,$or1,$eq12,$eq13,$iter4_iter,$sub18,res,$33,$add25,$add24,$add26,$bool21,$bool20,$bool23,$and1,$bool22,$eq7,quad_pos,next_c,$or5,$or4,$eq8,$bool13,next_valid_char,$or3,$or2,$eq2,$eq3,$and2,$eq1,$eq6,$cmp7,$eq4,$eq5,$cmp11,$cmp10,$cmp12,$bool8,$bool9,c,$eq14,i,$iter4_nextval,$34,$cmp9,$cmp8,$iter4_idx,leftbits,$iter4_array,$sub17,$add23;
		...
		next_valid_char = function(s, pos) {
			var $cmp5,$len4,c,$iter3_idx,i,$bool11,$iter3_nextval,$iter3_type,$32,$31,$add21,$cmp6,$iter3_iter,$bool10,$iter3_array,$add22;
			$iter3_iter = $p['range']((typeof ($add21=pos)==typeof ($add22=1) && (typeof $add21=='number'||typeof $add21=='string')?
				$add21+$add22:
				$p['op_add']($add21,$add22)), (($len4=s) === null?0:
		...
		while (typeof ($iter4_nextval=($iter4_type?($iter4_type > 0?$iter4_iter.next(true,true):$p['wrapped_next']($iter4_iter)):$iter4_array[$iter4_idx++])) != 'undefined') {
			...
			if ((($bool15=((($bool12=$or1=((($cmp7=c)===($cmp8='')?0:
					...
					(typeof $bool12.__nonzero__=='function'?
						...
						(typeof $bool12.__len__=='function'?
							($bool12.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?$or1:((($bool13=$or2=(($eq1=c)===($eq2='\x0A')&&$eq1===null?true:
					...
					(typeof $bool13.__nonzero__=='function'?
						...
						(typeof $bool13.__len__=='function'?
							($bool13.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?$or2:((($bool14=$or3=(($eq3=c)===($eq4='\x0D')&&$eq3===null?true:
	...
	$m['b2a_base64'] = function(s) {
		var $sub22,$sub23,$sub21,$sub24,$add42,$eq18,$mod4,result,$mod3,$add35,$eq15,$eq16,$eq17,$add29,$bool25,$add41,$add40,snippet,$bool26,$69,$68,$65,$64,$67,$66,$61,$$final,$63,$62,final_length,$add38,$add39,a,$70,b,$add32,$add33,$add30,$add31,$add36,$add37,$add34,$60,$58,$59,length,$len5,triples_gen,$55,$56,$57;
		...
		triples_gen.__bind_type__ = 0;
		triples_gen.__args__ = [null,null,['s']];
		a = triples_gen($p['slice'](s, 0, (typeof ($sub21=length)==typeof ($sub22=final_length) && (typeof $sub21=='number'||typeof $sub21=='string')?
			$sub21-$sub22:
			$p['op_sub']($sub21,$sub22))));
		result = function(){
			var A,C,B,$iter6_idx,$iter6_type,$54,$49,$iter6_array,$48,$listcomp4,$50,$51,$iter6_iter,$53,$47,$52,$iter6_nextval;
	$listcomp4 = $p['list']();
		$iter6_iter = a;
		...
		while (typeof ($iter6_nextval=($iter6_type?($iter6_type > 0?$iter6_iter.next(true,true):$p['wrapped_next']($iter6_iter)):$iter6_array[$iter6_idx++])) != 'undefined') {
			...
			$listcomp4['append'](''['join']($p['list']([(typeof ($47=$m['table_b2a_base64']).__array != 'undefined'?
	...
	return $listcomp4;}();
		$$final = $p['slice'](s, (typeof ($sub23=length)==typeof ($sub24=final_length) && (typeof $sub23=='number'||typeof $sub23=='string')?
			$sub23-$sub24:
		...
		if ((($bool25=(($eq15=final_length)===($eq16=0)&&$eq15===null?true:
			...
			snippet = (typeof ($add31=(typeof ($add29=(typeof ($57=$m['table_b2a_base64']).__array != 'undefined'?
				((typeof $57.__array[$58=((a)>>(2))&(63)]) != 'undefined'?$57.__array[$58]:
					$57.__getitem__($58)):
					$57.__getitem__(((a)>>(2))&(63))))==typeof ($add30=(typeof ($59=$m['table_b2a_base64']).__array != 'undefined'?
				((typeof $59.__array[$60=((a)<<(4))&(63)]) != 'undefined'?$59.__array[$60]:
					$59.__getitem__($60)):
					$59.__getitem__(((a)<<(4))&(63)))) && (typeof $add29=='number'||typeof $add29=='string')?
				$add29+$add30:
			...
			snippet = (typeof ($add37=(typeof ($add35=(typeof ($add33=(typeof ($65=$m['table_b2a_base64']).__array != 'undefined'?
				((typeof $65.__array[$66=((a)>>(2))&(63)]) != 'undefined'?$65.__array[$66]:
					$65.__getitem__($66)):
					$65.__getitem__(((a)>>(2))&(63))))==typeof ($add34=(typeof ($67=$m['table_b2a_base64']).__array != 'undefined'?
				((typeof $67.__array[$68=(((a)<<(4))|(((b)>>(4))&(15)))&(63)]) != 'undefined'?$67.__array[$68]:
					$67.__getitem__($68)):
					$67.__getitem__((((a)<<(4))|(((b)>>(4))&(15)))&(63)))) && (typeof $add33=='number'||typeof $add33=='string')?
				$add33+$add34:
				...
				((typeof $69.__array[$70=((b)<<(2))&(63)]) != 'undefined'?$69.__array[$70]:
					$69.__getitem__($70)):
					$69.__getitem__(((b)<<(2))&(63)))) && (typeof $add35=='number'||typeof $add35=='string')?
				$add35+$add36:
				$p['op_add']($add35,$add36)))==typeof ($add38='=') && (typeof $add37=='number'||typeof $add37=='string')?
				$add37+$add38:
				$p['op_add']($add37,$add38));
		}
		return (typeof ($add41=(typeof ($add39=''['join'](result))==typeof ($add40=snippet) && (typeof $add39=='number'||typeof $add39=='string')?
			$add39+$add40:
			$p['op_add']($add39,$add40)))==typeof ($add42='\x0A') && (typeof $add41=='number'||typeof $add41=='string')?
			$add41+$add42:
	...
	$m['a2b_qp'] = function(s, header) {
		...
		var $cmp20,$and8,$and3,$and4,$and5,$and6,$and7,$eq21,$eq20,$eq23,$eq22,$eq25,$eq24,$eq27,$eq26,$eq29,$eq28,$eq19,$eq32,$eq30,$eq31,$add60,$bool40,$bool27,$bool29,$bool28,$89,$88,$87,$86,$85,$84,$83,$82,$81,$80,$add50,$73,$add52,$add53,$add54,$add55,$74,$add57,$add58,$add59,$78,$79,$bool32,$bool33,$bool30,$bool31,$bool36,$bool37,$bool34,$bool35,$bool38,$bool39,ch,$90,$add49,$add48,$add47,$add46,$add45,$add44,$add43,$72,$add51,odata,$71,$76,$77,$add56,$75,$len6,$len7,$len8,$len9,inp,$or7,$or8,$cmp15,$cmp14,$cmp17,$cmp16,$cmp13,$cmp19,$cmp18;
		inp = 0;
		odata = $p['list']([]);
			...
			if ((($bool28=(($eq19=(typeof ($71=s).__array != 'undefined'?
				...
				if ((($bool31=((($bool30=$or7=(($eq21=(typeof ($73=s).__array != 'undefined'?
					((typeof $73.__array[$74=inp]) != 'undefined'?$73.__array[$74]:
						$73.__getitem__($74)):
						$73.__getitem__(inp)))===($eq22='\x0A')&&$eq21===null?true:
					...
					((typeof $75.__array[$76=inp]) != 'undefined'?$75.__array[$76]:
						$75.__getitem__($76)):
						$75.__getitem__(inp)))===($eq24='\x0D')&&$eq23===null?true:
					...
					if ((($bool32=!(($eq25=(typeof ($77=s).__array != 'undefined'?
						((typeof $77.__array[$78=inp]) != 'undefined'?$77.__array[$78]:
							$77.__getitem__($78)):
							$77.__getitem__(inp)))===($eq26='\x0A')&&$eq25===null?true:
						...
						while ((($bool34=((($bool33=$and3=((($cmp17=inp)===($cmp18=(($len8=s) === null?0:
							...
							((typeof $79.__array[$80=inp]) != 'undefined'?$79.__array[$80]:
								$79.__getitem__($80)):
								$79.__getitem__(inp)))===($eq28='\x0A')&&$eq27===null?true:
					...
					((typeof $85.__array[$86=(typeof ($add51=inp)==typeof ($add52=1) && (typeof $add51=='number'||typeof $add51=='string')?
					$add51+$add52:
					$p['op_add']($add51,$add52))]) != 'undefined'?$85.__array[$86]:
						$85.__getitem__($86)):
						$85.__getitem__((typeof ($add51=inp)==typeof ($add52=1) && (typeof $add51=='number'||typeof $add51=='string')?
					$add51+$add52:
						...
						(typeof $bool38=='object'?
							(typeof $bool38.__nonzero__=='function'?
								...
								(typeof $bool38.__len__=='function'?
									...
									true ) ) :
							 true ) )) {
					ch = $p['chr']($p['float_int']($p['slice'](s, inp, (typeof ($add53=inp)==typeof ($add54=2) && (typeof $add53=='number'||typeof $add53=='string')?
						$add53+$add54:
						$p['op_add']($add53,$add54))), 16));
	...
	$m['b2a_qp'] = function(data, quotetabs, istext, header) {
		...
		var $add89,$add88,$sub26,$sub25,$add83,$add66,$add81,$add80,$add87,$add86,$add85,$add84,$eq54,$eq55,$cmp22,$cmp23,$cmp24,$cmp25,$cmp26,$eq53,$cmp28,$bool50,$eq58,$eq59,$99,lf,$bool82,$bool81,$bool80,$bool84,$cmp33,$and31,$or28,$and32,$add82,$or24,$or25,$or26,$and33,$or20,$or21,$or22,$or23,$and9,$105,$bool59,$and38,$and39,$cmp38,$and34,$cmp36,$cmp35,$cmp34,$and30,$cmp32,$cmp31,$cmp30,$add76,$add77,$add74,$add75,$add72,$add73,$add70,$cmp21,$add71,$eq56,$add78,$add79,$eq57,$and35,$eq50,$eq51,$eq52,$cmp27,$eq33,$and29,$and28,$eq36,$eq37,$eq34,$eq35,$and23,$and22,$eq38,$eq39,$and27,$and26,$and25,$and24,$add65,$add64,$add67,$add61,$and36,$add63,$add62,$add69,$add68,$and37,linelen,$bool47,$bool46,$bool45,$bool44,$bool43,$bool42,$bool41,$add90,$bool49,$bool48,crlf,$len10,$len11,c,$len13,$len14,$len15,$eq81,$eq80,$bool54,$bool55,$bool56,$bool57,$98,$bool51,$bool52,$bool53,$94,$95,$96,$97,$bool58,$91,$92,$93,$bool83,$bool61,$bool60,$bool63,$bool62,$bool65,$bool64,$bool67,$bool66,$bool69,$bool68,odata,$len12,$eq82,$or27,$eq69,$eq68,$eq65,$eq64,$eq67,$eq66,$eq61,$eq60,$eq63,$eq62,$or15,$or14,$or17,$or16,$or11,$or10,$or13,$or12,$or19,$or18,$bool78,$bool79,$bool76,$bool77,$bool74,$bool75,inp,$bool73,$bool70,$bool71,ch,$and21,$and20,$eq78,$eq79,$eq76,$eq77,$eq74,$eq75,$eq72,$eq73,$eq70,$eq71,$101,$100,$103,$102,MAXLINESIZE,$104,$107,$106,$108,$or9,$and12,$and13,$and10,$and11,$and16,$and17,$and14,$and15,$and18,$and19,$eq49,$eq48,$eq43,$eq42,$eq41,$eq40,$eq47,$eq46,$eq45,$eq44,$cmp37,$cmp29,$bool72;
		MAXLINESIZE = 76;
		lf = data['find']('\x0A');
		crlf = ((($bool41=$and9=((($cmp21=lf)===($cmp22=0)?0:
			...
			((typeof $91.__array[$92=(typeof ($sub25=lf)==typeof ($sub26=1) && (typeof $sub25=='number'||typeof $sub25=='string')?
			$sub25-$sub26:
			$p['op_sub']($sub25,$sub26))]) != 'undefined'?$91.__array[$92]:
				$91.__getitem__($92)):
				$91.__getitem__((typeof ($sub25=lf)==typeof ($sub26=1) && (typeof $sub25=='number'||typeof $sub25=='string')?
			$sub25-$sub26:
			$p['op_sub']($sub25,$sub26)))))===($eq34='\x0D')&&$eq33===null?true:
		...
		while ((($bool42=((($cmp23=inp)===($cmp24=(($len10=data) === null?0:
			...
			if ((($bool66=((($bool53=$or16=((($cmp25=c)===($cmp26='~')?0:
				...
				((typeof $95.__array[$96=(typeof ($add61=inp)==typeof ($add62=1) && (typeof $add61=='number'||typeof $add61=='string')?
				$add61+$add62:
				$p['op_add']($add61,$add62))]) != 'undefined'?$95.__array[$96]:
					$95.__getitem__($96)):
					$95.__getitem__((typeof ($add61=inp)==typeof ($add62=1) && (typeof $add61=='number'||typeof $add61=='string')?
				$add61+$add62:
				$p['op_add']($add61,$add62)))))===($eq46='\x0A')&&$eq45===null?true:
				...
				((typeof $97.__array[$98=(typeof ($add63=inp)==typeof ($add64=1) && (typeof $add63=='number'||typeof $add63=='string')?
				$add63+$add64:
				$p['op_add']($add63,$add64))]) != 'undefined'?$97.__array[$98]:
					$97.__getitem__($98)):
					$97.__getitem__((typeof ($add63=inp)==typeof ($add64=1) && (typeof $add63=='number'||typeof $add63=='string')?
				$add63+$add64:
				$p['op_add']($add63,$add64)))))===($eq48='\x0D')&&$eq47===null?true:
					...
					(typeof $bool49.__nonzero__=='function'?
						...
						(typeof $bool49.__len__=='function'?
							($bool49.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?((($bool50=$or12=(($eq49=c)===($eq50='\x0D')&&$eq49===null?true:
					...
					(typeof $bool50.__nonzero__=='function'?
						...
						(typeof $bool50.__len__=='function'?
							($bool50.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?$or12:(($eq51=c)===($eq52='\x0A')&&$eq51===null?true:
					...
					(typeof $bool57.__nonzero__=='function'?
						...
						(typeof $bool57.__len__=='function'?
							($bool57.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?$or20:((($bool58=$or21=((($bool52=$and18=((($bool51=$or14=(($eq53=c)===($eq54='\x09')&&$eq53===null?true:
					...
					(typeof $bool52.__nonzero__=='function'?
						...
						(typeof $bool52.__len__=='function'?
							($bool52.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?(($eq57=(typeof ($add65=inp)==typeof ($add66=1) && (typeof $add65=='number'||typeof $add65=='string')?
				$add65+$add66:
				$p['op_add']($add65,$add66)))===($eq58=(($len12=data) === null?0:
					...
					(typeof $bool59.__nonzero__=='function'?
						...
						(typeof $bool59.__len__=='function'?
							($bool59.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?((($bool60=$and21=!(($eq59=c)===($eq60='\x0D')&&$eq59===null?true:
					...
					(typeof $bool60.__nonzero__=='function'?
						...
						(typeof $bool60.__len__=='function'?
							($bool60.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?((($bool61=$and22=!(($eq61=c)===($eq62='\x0A')&&$eq61===null?true:
					...
					(typeof $bool64.__nonzero__=='function'?
						...
						(typeof $bool64.__len__=='function'?
							($bool64.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?((($bool65=$and26=!(($eq63=c)===($eq64='\x09')&&$eq63===null?true:
				...
				if ((($bool73=((($bool69=$and28=istext) === null || $bool69 === false || $bool69 === 0 || $bool69 === '' ?
						...
						(typeof $bool69.__nonzero__=='function'?
							...
							(typeof $bool69.__len__=='function'?
								($bool69.__len__()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?((($bool70=$or25=(($eq67=c)===($eq68='\x0A')&&$eq67===null?true:
						...
						(typeof $bool70.__nonzero__=='function'?
							...
							(typeof $bool70.__len__=='function'?
								($bool70.__len__()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?$or25:((($bool71=$and30=((($cmp31=(typeof ($add73=inp)==typeof ($add74=1) && (typeof $add73=='number'||typeof $add73=='string')?
					$add73+$add74:
					$p['op_add']($add73,$add74)))===($cmp32=(($len13=data) === null?0:
						...
						(typeof $bool71.__nonzero__=='function'?
							...
							(typeof $bool71.__len__=='function'?
								($bool71.__len__()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?((($bool72=$and31=(($eq69=c)===($eq70='\x0D')&&$eq69===null?true:
					...
					((typeof $99.__array[$100=(typeof ($add75=inp)==typeof ($add76=1) && (typeof $add75=='number'||typeof $add75=='string')?
					$add75+$add76:
					$p['op_add']($add75,$add76))]) != 'undefined'?$99.__array[$100]:
						$99.__getitem__($100)):
						$99.__getitem__((typeof ($add75=inp)==typeof ($add76=1) && (typeof $add75=='number'||typeof $add75=='string')?
					$add75+$add76:
					$p['op_add']($add75,$add76)))))===($eq72='\x0A')&&$eq71===null?true:
					...
					if ((($bool76=((($bool74=$and33=((($cmp33=(($len14=odata) === null?0:
						...
						((typeof $101.__array[$102=(typeof ($usub1=1)=='number'?
						-$usub1:
						$p['op_usub']($usub1))]) != 'undefined'?$101.__array[$102]:
							$101.__getitem__($102)):
							$101.__getitem__((typeof ($usub1=1)=='number'?
						-$usub1:
						$p['op_usub']($usub1)))))===($eq74=' ')&&$eq73===null?true:
						...
						((typeof $103.__array[$104=(typeof ($usub2=1)=='number'?
						-$usub2:
						$p['op_usub']($usub2))]) != 'undefined'?$103.__array[$104]:
							$103.__getitem__($104)):
							$103.__getitem__((typeof ($usub2=1)=='number'?
						-$usub2:
						$p['op_usub']($usub2)))))===($eq76='\x09')&&$eq75===null?true:
						...
						ch = $p['ord']((typeof ($105=odata).__array != 'undefined'?
							((typeof $105.__array[$106=(typeof ($usub3=1)=='number'?
							-$usub3:
							$p['op_usub']($usub3))]) != 'undefined'?$105.__array[$106]:
								$105.__getitem__($106)):
								$105.__getitem__((typeof ($usub3=1)=='number'?
							-$usub3:
							$p['op_usub']($usub3)))));
					...
					odata['append']('\x0A');
					if ((($bool78=(($eq77=c)===($eq78='\x0D')&&$eq77===null?true:
					...
					if ((($bool81=((($bool79=$and35=((($cmp35=(typeof ($add81=inp)==typeof ($add82=1) && (typeof $add81=='number'||typeof $add81=='string')?
						$add81+$add82:
						$p['op_add']($add81,$add82)))===($cmp36=(($len15=data) === null?0:
						...
						((typeof $107.__array[$108=(typeof ($add83=inp)==typeof ($add84=1) && (typeof $add83=='number'||typeof $add83=='string')?
						$add83+$add84:
						$p['op_add']($add83,$add84))]) != 'undefined'?$107.__array[$108]:
							$107.__getitem__($108)):
							$107.__getitem__((typeof ($add83=inp)==typeof ($add84=1) && (typeof $add83=='number'||typeof $add83=='string')?
						$add83+$add84:
						$p['op_add']($add83,$add84)))))===($eq80='\x0A')&&$eq79===null?true:
							...
							(typeof $bool80.__nonzero__=='function'?
								...
								(typeof $bool80.__len__=='function'?
									($bool80.__len__()>0 ?
										...
										false) :
									true ) ) :
							 true ) )?((((($cmp37=(typeof ($add85=linelen)==typeof ($add86=1) && (typeof $add85=='number'||typeof $add85=='string')?
						$add85+$add86:
	...
	$m['hex'] = function(n) {
		var arr,$iter7_array,$110,nibble,sign,$cmp40,$bool86,$bool85,$add94,$iter7_type,$109,$iter7_iter,$add91,$add92,$add93,$cmp39,$iter7_idx,$eq84,$eq83,$iter7_nextval,hex_gen;
		...
		return (typeof ($add93=sign)==typeof ($add94=''['join'](arr)) && (typeof $add93=='number'||typeof $add93=='string')?
			$add93+$add94:
	...
	$m['two_hex_digits'] = function(n) {
		...
		return (typeof ($add95=(typeof ($111=$m['hex_numbers']).__array != 'undefined'?
			((typeof $111.__array[$112=(typeof ($div3=n)==typeof ($div4=16) && typeof $div3=='number' && $div4 !== 0?
			$div3/$div4:
			$p['op_div']($div3,$div4))]) != 'undefined'?$111.__array[$112]:
				$111.__getitem__($112)):
				$111.__getitem__((typeof ($div3=n)==typeof ($div4=16) && typeof $div3=='number' && $div4 !== 0?
			$div3/$div4:
			$p['op_div']($div3,$div4)))))==typeof ($add96=(typeof ($113=$m['hex_numbers']).__array != 'undefined'?
			((typeof $113.__array[$114=(typeof ($mod7=n)==typeof ($mod8=16) && typeof $mod7=='number'?
			(($mod7=$mod7%$mod8)<0&&$mod8>0?$mod7+$mod8:$mod7):
			$p['op_mod']($mod7,$mod8))]) != 'undefined'?$113.__array[$114]:
				$113.__getitem__($114)):
				$113.__getitem__((typeof ($mod7=n)==typeof ($mod8=16) && typeof $mod7=='number'?
			(($mod7=$mod7%$mod8)<0&&$mod8>0?$mod7+$mod8:$mod7):
	...
	$m['rlecode_hqx'] = function(s) {
		var $eq116,$eq112,$mul8,$iter13_idx,$cmp42,$cmp43,$cmp41,$cmp44,$add104,$eq105,$eq107,$eq106,$eq109,$eq108,$and41,$and40,prev,$iter13_array,$add101,$add100,$add103,$add102,$add99,$200,$eq110,$bool105,$bool104,$bool107,$bool106,$bool101,$bool100,$bool103,$bool102,$mul7,$mul6,$mul5,$bool108,count,$eq113,c,$eq111,$iter13_nextval,$eq114,$iter13_iter,$bool99,$eq115,$iter13_type,$198,$199,$197,result;
		...
		if ((($bool101=(($eq105=(typeof ($199=s).__array != 'undefined'?
			((typeof $199.__array[$200=(typeof ($usub6=1)=='number'?
			-$usub6:
			$p['op_usub']($usub6))]) != 'undefined'?$199.__array[$200]:
				$199.__getitem__($200)):
				$199.__getitem__((typeof ($usub6=1)=='number'?
			-$usub6:
			$p['op_usub']($usub6)))))===($eq106='!')&&$eq105===null?true:
				...
				(typeof $bool101=='object'?
					(typeof $bool101.__nonzero__=='function'?
						...
						(typeof $bool101.__len__=='function'?
							...
							true ) ) :
					 true ) )) {
			s = (typeof ($add99=$p['slice'](s, 1, null))==typeof ($add100='?') && (typeof $add99=='number'||typeof $add99=='string')?
				$add99+$add100:
				$p['op_add']($add99,$add100));
		}
		else {
			s = (typeof ($add101=$p['slice'](s, 1, null))==typeof ($add102='!') && (typeof $add101=='number'||typeof $add101=='string')?
				$add101+$add102:
						...
						(typeof $bool104=='object'?
							(typeof $bool104.__nonzero__=='function'?
								...
								(typeof $bool104.__len__=='function'?
									...
									true ) ) :
							 true ) )) {
					if ((($bool105=!(($eq111=prev)===($eq112='ê')&&$eq111===null?true:
						...
						(typeof $bool106=='object'?
							(typeof $bool106.__nonzero__=='function'?
								...
								(typeof $bool106.__len__=='function'?
									...
									true ) ) :
							 true ) )) {
					if ((($bool107=!(($eq113=prev)===($eq114='ê')&&$eq113===null?true:
						...
						result['extend']((typeof ($mul7=$p['list'](['ê', '\x00']))==typeof ($mul8=count) && typeof $mul7=='number'?
							$mul7*$mul8:
							$p['op_mul']($mul7,$mul8)));
					}
				}
				else {
					if ((($bool108=!(($eq115=prev)===($eq116='ê')&&$eq115===null?true:
							...
							(typeof $bool108=='object'?
								(typeof $bool108.__nonzero__=='function'?
									...
									(typeof $bool108.__len__=='function'?
										...
										true ) ) :
								 true ) )) {
						result['extend']($p['list']([prev, 'ê', $p['chr'](count)]));
					}
					else {
						result['extend']($p['list'](['ê', '\x00', 'ê', $p['chr'](count)]));
					}
				}
				count = 1;
				prev = c;
	...
	$m['rledecode_hqx'] = function(s) {
		var $sub27,$sub28,$208,result,$cmp46,$cmp45,$mul9,snippet,prev,$iter14_array,$iter14_type,$202,$203,$201,$206,$207,$204,$205,$iter14_iter,$bool109,$iter14_idx,$iter14_nextval,count,$mul10;
		s = s['$$split']('ê');
		...
		while (typeof ($iter14_nextval=($iter14_type?($iter14_type > 0?$iter14_iter.next(true,false):$p['wrapped_next']($iter14_iter)):$iter14_array[$iter14_idx++])) != 'undefined') {
			...
			if ((($bool109=((($cmp45=count)===($cmp46=0)?0:
				...
				result['append']((typeof ($mul9=(typeof ($207=prev).__array != 'undefined'?
					((typeof $207.__array[$208=(typeof ($usub7=1)=='number'?
					-$usub7:
					$p['op_usub']($usub7))]) != 'undefined'?$207.__array[$208]:
						$207.__getitem__($208)):
						$207.__getitem__((typeof ($usub7=1)=='number'?
					-$usub7:
					$p['op_usub']($usub7)))))==typeof ($mul10=(typeof ($sub27=count)==typeof ($sub28=1) && (typeof $sub27=='number'||typeof $sub27=='string')?
					$sub27-$sub28:
	...
	$m['crc32'] = function(s, crc) {
		...
		var $sub29,$cmp48,result,$mod9,$cmp47,$pow7,$pow6,$pow5,$pow4,$pow3,$pow2,$pow1,$pow8,$sub30,$209,$add105,$mod10,$add106,$iter15_array,$iter15_iter,c,$bool110,$iter15_idx,$210,$iter15_nextval,$iter15_type;
		result = 0;
		...
		if ((($bool110=((($cmp47=result)===($cmp48=(typeof ($pow1=2)==typeof ($pow2=31) && typeof $pow1=='number'?
			Math.pow($pow1,$pow2):
			...
			result = (typeof ($sub29=(typeof ($mod9=(typeof ($add105=result)==typeof ($add106=(typeof ($pow3=2)==typeof ($pow4=31) && typeof $pow3=='number'?
				...
				$add105+$add106:
				$p['op_add']($add105,$add106)))==typeof ($mod10=(typeof ($pow5=2)==typeof ($pow6=32) && typeof $pow5=='number'?
				Math.pow($pow5,$pow6):
				$p['op_pow']($pow5,$pow6))) && typeof $mod9=='number'?
				(($mod9=$mod9%$mod10)<0&&$mod10>0?$mod9+$mod10:$mod9):
				$p['op_mod']($mod9,$mod10)))==typeof ($sub30=(typeof ($pow7=2)==typeof ($pow8=31) && typeof $pow7=='number'?
				Math.pow($pow7,$pow8):
	...
	$m['b2a_hex'] = function(s) {
		var $iter16_idx,$add112,$add113,$add110,$add111,$$char,$cmp49,result,$iter16_iter,$iter16_type,$iter16_nextval,$add114,$sub31,$sub33,$sub32,$sub34,$add107,$add109,$add108,$$char,$cmp51,$cmp50,$cmp52,$iter16_array,$bool112,c,$bool111;
		result = $p['list']([]);
		$iter16_iter = s;
		...
		while (typeof ($iter16_nextval=($iter16_type?($iter16_type > 0?$iter16_iter.next(true,false):$p['wrapped_next']($iter16_iter)):$iter16_array[$iter16_idx++])) != 'undefined') {
			...
			if ((($bool111=((($cmp49=c)===($cmp50=9)?0:
				...
				c = (typeof ($sub31=(typeof ($add107=c)==typeof ($add108=$p['ord']('a')) && (typeof $add107=='number'||typeof $add107=='string')?
					$add107+$add108:
					$p['op_add']($add107,$add108)))==typeof ($sub32=10) && (typeof $sub31=='number'||typeof $sub31=='string')?
					$sub31-$sub32:
			...
			if ((($bool112=((($cmp51=c)===($cmp52=9)?0:
				...
				c = (typeof ($sub33=(typeof ($add111=c)==typeof ($add112=$p['ord']('a')) && (typeof $add111=='number'||typeof $add111=='string')?
					$add111+$add112:
					$p['op_add']($add111,$add112)))==typeof ($sub34=10) && (typeof $sub33=='number'||typeof $sub33=='string')?
					$sub33-$sub34:
	...
	$m['a2b_hex'] = function(t) {
		var $iter17_nextval,a,$or29,$iter17_iter,$add116,$cmp55,$bool115,pairs_gen,$iter17_array,b,$bool116,$iter17_idx,$add115,$iter17_type,$cmp53,$cmp56,$or30,$cmp54,result;
		result = $p['list']([]);
		...
		$iter17_idx = 0;
		while (typeof ($iter17_nextval=($iter17_type?($iter17_type > 0?$iter17_iter.next(true,true):$p['wrapped_next']($iter17_iter)):$iter17_array[$iter17_idx++])) != 'undefined') {
			...
			result['append']($p['chr']((typeof ($add115=(a)<<(4))==typeof ($add116=b) && (typeof $add115=='number'||typeof $add115=='string')?
				$add115+$add116:
