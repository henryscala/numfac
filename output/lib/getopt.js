...
$pyjs.loaded_modules['getopt'] = function (__mod_name__) {
					...
					(typeof $bool6=='object'?
						(typeof $bool6.__nonzero__=='function'?
							...
							(typeof $bool6.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				var $tupleassign1 = (typeof do_longs == "undefined"?$m.do_longs:do_longs)(opts, $p['slice']((typeof ($9=args).__array != 'undefined'?
					((typeof $9.__array[$10=0]) != 'undefined'?$9.__array[$10]:
						$9.__getitem__($10)):
						$9.__getitem__(0)), 2, null), longopts, $p['slice'](args, 1, null));
				opts = $tupleassign1.__getitem__(0);
				args = $tupleassign1.__getitem__(1);
			}
			else {
				var $tupleassign2 = (typeof do_shorts == "undefined"?$m.do_shorts:do_shorts)(opts, $p['slice']((typeof ($11=args).__array != 'undefined'?
					((typeof $11.__array[$12=0]) != 'undefined'?$11.__array[$12]:
						$11.__getitem__($12)):
						$11.__getitem__(0)), 1, null), shortopts, $p['slice'](args, 1, null));
	...
	$m['gnu_getopt'] = function(args, shortopts, longopts) {
		if (typeof longopts == 'undefined') longopts=arguments.callee.__args__[4][1];
		var $bool10,prog_args,$bool12,$bool13,all_options_first,$eq10,$eq11,$eq12,$21,$20,$23,$22,$24,$bool11,$eq8,$eq9,$eq7,$bool7,$bool8,$bool9,$14,$15,$16,$17,$13,$18,$19,$add2,$add3,$add1,$add4,opts;
		opts = $p['list']([]);
		prog_args = $p['list']([]);
					...
					(typeof $bool10=='object'?
						(typeof $bool10.__nonzero__=='function'?
							...
							(typeof $bool10.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				prog_args = (typeof ($add1=prog_args)==typeof ($add2=$p['slice'](args, 1, null)) && (typeof $add1=='number'||typeof $add1=='string')?
					$add1+$add2:
					$p['op_add']($add1,$add2));
				break;
			}
			if ((($bool11=(($eq9=$p['slice']((typeof ($15=args).__array != 'undefined'?
					...
					(typeof $bool11=='object'?
						(typeof $bool11.__nonzero__=='function'?
							...
							(typeof $bool11.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				var $tupleassign3 = (typeof do_longs == "undefined"?$m.do_longs:do_longs)(opts, $p['slice']((typeof ($17=args).__array != 'undefined'?
					((typeof $17.__array[$18=0]) != 'undefined'?$17.__array[$18]:
						$17.__getitem__($18)):
						$17.__getitem__(0)), 2, null), longopts, $p['slice'](args, 1, null));
				opts = $tupleassign3.__getitem__(0);
				args = $tupleassign3.__getitem__(1);
			}
			else if ((($bool12=(($eq11=$p['slice']((typeof ($19=args).__array != 'undefined'?
					...
					(typeof $bool12=='object'?
						(typeof $bool12.__nonzero__=='function'?
							...
							(typeof $bool12.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				var $tupleassign4 = (typeof do_shorts == "undefined"?$m.do_shorts:do_shorts)(opts, $p['slice']((typeof ($21=args).__array != 'undefined'?
					((typeof $21.__array[$22=0]) != 'undefined'?$21.__array[$22]:
						$21.__getitem__($22)):
						$21.__getitem__(0)), 1, null), shortopts, $p['slice'](args, 1, null));
	...
	$m['do_longs'] = function(opts, opt, longopts, args) {
		var $bool18,$bool19,$bool14,$bool15,$bool16,$bool17,$eq13,$eq14,$25,$26,$bool20,optarg,$or1,$or2,has_arg,i,$add6,$add7,$add5,$add8;
		i = opt['find']('=');
		if ((($bool14=(($eq13=i)===($eq14=(typeof ($usub1=1)=='number'?
			-$usub1:
			$p['op_usub']($usub1)))&&$eq13===null?true:
			...
			var $tupleassign5 = $p['tuple']([$p['slice'](opt, 0, i), $p['slice'](opt, (typeof ($add5=i)==typeof ($add6=1) && (typeof $add5=='number'||typeof $add5=='string')?
				$add5+$add6:
		...
		if ((($bool15=has_arg) === null || $bool15 === false || $bool15 === 0 || $bool15 === '' ?
			...
			if ((($bool16=(optarg === null)) === null || $bool16 === false || $bool16 === 0 || $bool16 === '' ?
				...
				var $tupleassign7 = $p['tuple']([(typeof ($25=args).__array != 'undefined'?
					((typeof $25.__array[$26=0]) != 'undefined'?$25.__array[$26]:
						$25.__getitem__($26)):
						$25.__getitem__(0)), $p['slice'](args, 1, null)]);
	...
	$m['long_has_args'] = function(opt, longopts) {
		var $bool25,$cmp1,$28,$cmp2,$len1,$27,possibilities,$bool24,$bool27,$bool26,$add10,$bool23,$bool22,$len2,has_arg,$add9,$eq15,$eq16,unique_match;
		possibilities = function(){
			var $iter1_nextval,$iter1_type,o,$iter1_iter,$listcomp1,$bool21,$iter1_array,$iter1_idx;
	$listcomp1 = $p['list']();
		$iter1_iter = longopts;
	...
	$m['do_shorts'] = function(opts, optstring, shortopts, args) {
		var $29,opt,$eq20,$32,$bool32,$30,$31,$eq18,$eq19,$bool30,$bool31,$add11,$add12,optarg,$bool29,$bool28,$eq17;
		while ((($bool28=!(($eq17=optstring)===($eq18='')&&$eq17===null?true:
				...
				(typeof $bool28=='object'?
					(typeof $bool28.__nonzero__=='function'?
						...
						(typeof $bool28.__len__=='function'?
							...
							true ) ) :
					 true ) )) {
			var $tupleassign8 = $p['tuple']([(typeof ($29=optstring).__array != 'undefined'?
				((typeof $29.__array[$30=0]) != 'undefined'?$29.__array[$30]:
					$29.__getitem__($30)):
					$29.__getitem__(0)), $p['slice'](optstring, 1, null)]);
			...
			if ((($bool29=(typeof short_has_arg == "undefined"?$m.short_has_arg:short_has_arg)(opt, shortopts)) === null || $bool29 === false || $bool29 === 0 || $bool29 === '' ?
				...
				if ((($bool30=(($eq19=optstring)===($eq20='')&&$eq19===null?true:
					...
					var $tupleassign9 = $p['tuple']([(typeof ($31=args).__array != 'undefined'?
						((typeof $31.__array[$32=0]) != 'undefined'?$31.__array[$32]:
							$31.__getitem__($32)):
							$31.__getitem__(0)), $p['slice'](args, 1, null)]);
	...
	$m['short_has_arg'] = function(opt, shortopts) {
		var $add14,$iter2_nextval,$iter2_type,$iter2_iter,i,$34,$33,$eq23,$eq21,$bool33,$iter2_idx,$eq22,$len3,$add13,$iter2_array,$eq24;
					...
					(typeof $bool33=='object'?
						(typeof $bool33.__nonzero__=='function'?
							...
							(typeof $bool33.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				return shortopts['startswith'](':', (typeof ($add13=i)==typeof ($add14=1) && (typeof $add13=='number'||typeof $add13=='string')?
					$add13+$add14:
