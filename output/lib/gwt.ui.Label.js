...
$pyjs.loaded_modules['gwt.ui.Label'] = function (__mod_name__) {
    ...
    var self = this.prototype;
			...
			return (typeof ($add3=(typeof ($add1=$m['Widget']['_getProps']())==typeof ($add2=$m['InnerText']['_getProps']()) && (typeof $add1=='number'||typeof $add1=='string')?
				$add1+$add2:
				$p['op_add']($add1,$add2)))==typeof ($add4=(($attr1=($attr2=self)['_props']) == null || (($attr2.__is_instance__) && typeof $attr1 == 'function') || (typeof $attr1['__get__'] == 'function')?
						$p['getattr']($attr2, '_props'):
						self['_props'])) && (typeof $add3=='number'||typeof $add3=='string')?
				$add3+$add4:
				$p['op_add']($add3,$add4));
		}
	, 2, [null,null,['self']]);
