...
$pyjs.loaded_modules['gwt.ui.Composite'] = function (__mod_name__) {
	...
	, 1, [null,['kwargs'],['self'],['widget', null]]);
		...
		$method = $pyjs__bind_method2('initWidget', function(widget) {
			...
			var $attr1,$bool2,$attr2;
			if ((($bool2=((($attr1=($attr2=self)['widget']) == null || (($attr2.__is_instance__) && typeof $attr1 == 'function') || (typeof $attr1['__get__'] == 'function')?
						$p['getattr']($attr2, 'widget'):
						self['widget']) !== null)) === null || $bool2 === false || $bool2 === 0 || $bool2 === '' ?
					false :
					(typeof $bool2=='object'?
	...
	, 1, [null,null,['self'],['widget']]);
		...
		$method = $pyjs__bind_method2('isAttached', function() {
			...
			var $bool3,$attr3,$attr4;
			if ((($bool3=((($attr3=($attr4=self)['widget']) == null || (($attr4.__is_instance__) && typeof $attr3 == 'function') || (typeof $attr3['__get__'] == 'function')?
						$p['getattr']($attr4, 'widget'):
						self['widget']) !== null)) === null || $bool3 === false || $bool3 === 0 || $bool3 === '' ?
					false :
					(typeof $bool3=='object'?
