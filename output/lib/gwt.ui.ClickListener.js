...
$pyjs.loaded_modules['gwt.ui.ClickListener'] = function (__mod_name__) {
	...
	, 1, [null,null,['self'],['listener']]);
		...
		$method = $pyjs__bind_method2('onBrowserEvent', function(event) {
			...
			var $iter1_iter,$iter2_type,$iter2_iter,$iter1_array,type,$attr8,$iter1_nextval,$eq2,$eq3,$eq1,$attr5,$attr7,$attr6,listener,$bool3,$iter2_idx,$bool1,$bool6,$eq4,$bool4,$bool5,$bool2,$iter2_nextval,$iter1_type,$iter1_idx,$iter2_array;
					...
					(typeof $bool1=='object'?
						(typeof $bool1.__nonzero__=='function'?
							...
							(typeof $bool1.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				if ((($bool2=(($attr5=($attr6=self)['_clickPreventDefault']) == null || (($attr6.__is_instance__) && typeof $attr5 == 'function') || (typeof $attr5['__get__'] == 'function')?
							$p['getattr']($attr6, '_clickPreventDefault'):
							self['_clickPreventDefault'])) === null || $bool2 === false || $bool2 === 0 || $bool2 === '' ?
						false :
						(typeof $bool2=='object'?
					...
					(typeof $bool4=='object'?
						(typeof $bool4.__nonzero__=='function'?
							...
							(typeof $bool4.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				if ((($bool5=(($attr7=($attr8=self)['_clickPreventDefault']) == null || (($attr8.__is_instance__) && typeof $attr7 == 'function') || (typeof $attr7['__get__'] == 'function')?
							$p['getattr']($attr8, '_clickPreventDefault'):
							self['_clickPreventDefault'])) === null || $bool5 === false || $bool5 === 0 || $bool5 === '' ?
						false :
						(typeof $bool5=='object'?
