...
$pyjs.loaded_modules['gwt.ui.Widget'] = function (__mod_name__) {
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('setContextMenu', function(menu) {
			...
			var $attr9,$attr8,$attr7,$bool1,$attr10;
	...
	, 1, [null,null,['self'],['menu']]);
		...
		$method = $pyjs__bind_method2('onBrowserEvent', function(event) {
			...
			var $eq2,type,$eq1,$bool10,$bool2,$bool3,$bool6,$bool7,$bool4,$bool5,$bool8,$bool9,$attr11,$attr12;
			...
			if ((($bool8=$p['hasattr'](self, '_dropListeners')) === null || $bool8 === false || $bool8 === 0 || $bool8 === '' ?
					false :
					(typeof $bool8=='object'?
			...
			if ((($bool9=((($attr11=($attr12=self)['contextMenu']) == null || (($attr12.__is_instance__) && typeof $attr11 == 'function') || (typeof $attr11['__get__'] == 'function')?
						$p['getattr']($attr12, 'contextMenu'):
						self['contextMenu']) === null)) === null || $bool9 === false || $bool9 === 0 || $bool9 === '' ?
					false :
					(typeof $bool9=='object'?
			...
			if ((($bool10=(($eq1=type)===($eq2='contextmenu')&&$eq1===null?true:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('onAttach', function() {
			...
			var $bool11;
			if ((($bool11=self['isAttached']()) === null || $bool11 === false || $bool11 === 0 || $bool11 === '' ?
					false :
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('onDetach', function() {
			...
			var $bool13,$bool12;
			if ((($bool13=!(($bool12=self['isAttached']()) === null || $bool12 === false || $bool12 === 0 || $bool12 === '' ?
				false :
	...
	, 1, [null,null,['self'],['layoutData']]);
		...
		$method = $pyjs__bind_method2('setParent', function(parent) {
			...
			var oldparent,$and1,$bool14,$bool15,$bool16,$bool17,$attr18,$attr15,$attr14,$attr17,$attr16,$and2,$attr13;
			...
			if ((($bool14=(parent === null)) === null || $bool14 === false || $bool14 === 0 || $bool14 === '' ?
					false :
					(typeof $bool14=='object'?
						(typeof $bool14.__nonzero__=='function'?
							...
							(typeof $bool14.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				if ((($bool16=((($bool15=$and1=(oldparent !== null)) === null || $bool15 === false || $bool15 === 0 || $bool15 === '' ?
					false :
						...
						(typeof $bool15.__nonzero__=='function'?
							...
							(typeof $bool15.__len__=='function'?
								($bool15.__len__()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?(($attr15=($attr16=oldparent)['attached']) == null || (($attr16.__is_instance__) && typeof $attr15 == 'function') || (typeof $attr15['__get__'] == 'function')?
							$p['getattr']($attr16, 'attached'):
							oldparent['attached']):$and1)) === null || $bool16 === false || $bool16 === 0 || $bool16 === '' ?
						false :
			...
			else if ((($bool17=(($attr17=($attr18=parent)['attached']) == null || (($attr18.__is_instance__) && typeof $attr17 == 'function') || (typeof $attr17['__get__'] == 'function')?
						$p['getattr']($attr18, 'attached'):
						parent['attached'])) === null || $bool17 === false || $bool17 === 0 || $bool17 === '' ?
					false :
	...
	, 1, [null,null,['self'],['parent']]);
		...
		$method = $pyjs__bind_method2('removeFromParent', function() {
			...
			var $attr20,$bool18,$attr19;
			if ((($bool18=$p['hasattr']((($attr19=($attr20=self)['parent']) == null || (($attr20.__is_instance__) && typeof $attr19 == 'function') || (typeof $attr19['__get__'] == 'function')?
						$p['getattr']($attr20, 'parent'):
						self['parent']), 'remove')) === null || $bool18 === false || $bool18 === 0 || $bool18 === '' ?
					false :
