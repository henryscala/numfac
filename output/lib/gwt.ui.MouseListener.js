...
$pyjs.loaded_modules['gwt.ui.MouseListener'] = function (__mod_name__) {
	...
	$m['fireMouseEvent'] = function(listeners, sender, event) {
		var $iter5_nextval,$iter5_array,$iter3_array,$iter1_iter,$iter5_iter,to_element,$iter4_type,$iter5_type,$eq10,$iter2_type,$iter4_iter,$iter4_array,$iter5_idx,$iter3_idx,$iter2_iter,$iter3_nextval,$iter3_iter,$iter1_array,from_element,etype,$sub2,$sub1,$sub4,$eq8,$eq9,$iter1_nextval,$eq2,$eq3,$eq1,$eq6,$eq7,$eq4,$eq5,$bool2,$sub3,$iter2_idx,$bool1,$bool6,$bool7,$bool4,$iter3_type,$bool8,$bool9,$iter1_type,listener,$iter2_nextval,$bool3,$iter4_nextval,$iter4_idx,$iter1_idx,y,x,$bool5,$iter2_array;
		...
		if ((($bool1=(($eq1=etype)===($eq2='mousedown')&&$eq1===null?true:
			...
			if ((($bool6=!(($bool5=$m['DOM']['isOrHasChild'](sender['getElement'](), from_element)) === null || $bool5 === false || $bool5 === 0 || $bool5 === '' ?
				false :
				(typeof $bool5=='object'?
		...
		else if ((($bool7=(($eq9=etype)===($eq10='mouseout')&&$eq9===null?true:
			...
			if ((($bool9=!(($bool8=$m['DOM']['isOrHasChild'](sender['getElement'](), to_element)) === null || $bool8 === false || $bool8 === 0 || $bool8 === '' ?
				false :
				(typeof $bool8=='object'?
	...
	, 1, [null,null,['self'],['preventDefault', false]]);
		...
		$method = $pyjs__bind_method2('onBrowserEvent', function(event) {
			...
			var $bool10,$bool11,$attr5,$attr4,$attr6,$attr3,etype;
			etype = $m['DOM']['eventGetType'](event);
			if ((($bool10=$m['MOUSE_EVENTS'].__contains__(etype)) === null || $bool10 === false || $bool10 === 0 || $bool10 === '' ?
					false :
					(typeof $bool10=='object'?
						(typeof $bool10.__nonzero__=='function'?
							...
							(typeof $bool10.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				if ((($bool11=(($attr3=($attr4=self)['_mousePreventDefault']) == null || (($attr4.__is_instance__) && typeof $attr3 == 'function') || (typeof $attr3['__get__'] == 'function')?
							$p['getattr']($attr4, '_mousePreventDefault'):
							self['_mousePreventDefault'])) === null || $bool11 === false || $bool11 === 0 || $bool11 === '' ?
						false :
	...
	, 1, [null,null,['self'],['preventDefault', false]]);
		...
		$method = $pyjs__bind_method2('onBrowserEvent', function(event) {
			...
			var $attr9,$iter6_idx,$iter6_type,$bool13,$iter6_array,$attr10,listener,$bool12,$iter6_iter,velocity,etype,$eq11,$eq12,$iter6_nextval;
			etype = $m['DOM']['eventGetType'](event);
			if ((($bool12=(($eq11=etype)===($eq12='mousewheel')&&$eq11===null?true:
					...
					(typeof $bool12=='object'?
						(typeof $bool12.__nonzero__=='function'?
							...
							(typeof $bool12.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				if ((($bool13=(($attr9=($attr10=self)['_mouseWheelPreventDefault']) == null || (($attr10.__is_instance__) && typeof $attr9 == 'function') || (typeof $attr9['__get__'] == 'function')?
							$p['getattr']($attr10, '_mouseWheelPreventDefault'):
							self['_mouseWheelPreventDefault'])) === null || $bool13 === false || $bool13 === 0 || $bool13 === '' ?
						false :
