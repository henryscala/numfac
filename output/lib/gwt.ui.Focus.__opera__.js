...
$pyjs.loaded_modules['gwt.ui.Focus'] = function (__mod_name__) {
	...
	, 1, [null,null,['self'],['index']]);
		...
		$method = $pyjs__bind_method2('isEnabled', function() {
			...
			var $bool2,$pyjs_try_err;
			try {
				return !(($bool2=$m['DOM']['getBooleanAttribute'](self['getElement'](), 'disabled')) === null || $bool2 === false || $bool2 === 0 || $bool2 === '' ?
					false :
					(typeof $bool2=='object'?
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('setEnabled', function(enabled) {
			...
			var $bool3;
			$m['DOM']['setBooleanAttribute'](self['getElement'](), 'disabled', !(($bool3=enabled) === null || $bool3 === false || $bool3 === 0 || $bool3 === '' ?
				false :
				(typeof $bool3=='object'?
	...
	, 1, [null,null,['self'],['enabled']]);
		...
		$method = $pyjs__bind_method2('isReadonly', function() {
			...
			try {
				return !(($bool4=$m['DOM']['getBooleanAttribute'](self['getElement'](), 'readOnly')) === null || $bool4 === false || $bool4 === 0 || $bool4 === '' ?
					false :
					(typeof $bool4=='object'?
