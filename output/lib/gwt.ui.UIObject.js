...
$pyjs.loaded_modules['gwt.ui.UIObject'] = function (__mod_name__) {
	...
	$m['setStyleName'] = function(element, style, add) {
		var $add12,$bool10,lastPos,$add6,begin,$add5,$eq10,$eq11,$eq12,$eq13,$eq14,$bool8,$eq16,end,$eq15,$and1,$sub3,$sub2,$sub1,$bool11,$and2,$sub4,$or4,$eq8,$eq9,$or1,$or3,$or2,$eq2,$eq3,oldStyle,$eq1,$eq6,$eq7,$eq4,$eq5,$bool2,$bool3,$bool1,$bool6,$bool7,$bool4,$bool5,$cmp1,$4,$bool9,$2,$3,$1,last,idx,$cmp2,$len3,$add2,$add3,$add1,$len2,$add7,$add4,$len1,$add10,$add8,$add9,$add11;
			...
			(typeof $len1.__array != 'undefined' ? $len1.__array.length:
				(typeof $len1.__len__ == 'function'?$len1.__len__():
					(typeof $len1.length != 'undefined'?$len1.length:
						$p['len']($len1)))));
		while ((($bool2=!(($eq1=idx)===($eq2=(typeof ($usub1=1)=='number'?
			-$usub1:
		...
		if ((($bool8=add) === null || $bool8 === false || $bool8 === 0 || $bool8 === '' ?
				false :
				(typeof $bool8=='object'?
					(typeof $bool8.__nonzero__=='function'?
						...
						(typeof $bool8.__len__=='function'?
							...
							true ) ) :
					 true ) )) {
			if ((($bool9=(($eq11=idx)===($eq12=(typeof ($usub2=1)=='number'?
				-$usub2:
				$p['op_usub']($usub2)))&&$eq11===null?true:
			...
			if ((($bool10=!(($eq13=idx)===($eq14=(typeof ($usub3=1)=='number'?
				-$usub3:
				$p['op_usub']($usub3)))&&$eq13===null?true:
					...
					(typeof $bool10=='object'?
						(typeof $bool10.__nonzero__=='function'?
							...
							(typeof $bool10.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				if ((($bool11=(($eq15=idx)===($eq16=0)&&$eq15===null?true:
					...
					begin = $p['slice'](oldStyle, 0, (typeof ($sub3=idx)==typeof ($sub4=1) && (typeof $sub3=='number'||typeof $sub3=='string')?
						$sub3-$sub4:
						$p['op_sub']($sub3,$sub4)));
				}
				end = $p['slice'](oldStyle, (typeof ($add9=idx)==typeof ($add10=(($len3=style) === null?0:
    ...
    var self = this.prototype;
			...
			return (typeof ($add13=$m['Applier']['_getProps']())==typeof ($add14=(($attr1=($attr2=self)['_props']) == null || (($attr2.__is_instance__) && typeof $attr1 == 'function') || (typeof $attr1['__get__'] == 'function')?
						$p['getattr']($attr2, '_props'):
						self['_props'])) && (typeof $add13=='number'||typeof $add13=='string')?
				$add13+$add14:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('getStylePrimaryName', function() {
			...
			var $6,fullClassName,$5,$bool12;
			fullClassName = self['getStyleName']();
			if ((($bool12=fullClassName) === null || $bool12 === false || $bool12 === 0 || $bool12 === '' ?
					false :
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('getStyleAttribute', function(attribute) {
			...
			var el,$iter1_nextval,$iter1_type,$iter1_idx,$bool13,$iter1_iter,result,attr,$iter1_array;
			if ((($bool13=$p['isinstance'](attribute, $p['basestring'])) === null || $bool13 === false || $bool13 === 0 || $bool13 === '' ?
					false :
	...
	, 1, [null,null,['self'],['element']]);
		...
		$method = $pyjs__bind_method2('setHeight', function(height) {
			...
			var $attr14,$bool14,$attr13;
			if ((($bool14=(height === null)) === null || $bool14 === false || $bool14 === 0 || $bool14 === '' ?
					false :
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('setPixelSize', function(width, height) {
			...
			var $cmp5,$cmp4,$cmp6,$cmp3,$bool15,$bool16;
			if ((($bool15=((((($cmp3=width)===($cmp4=0)?0:
				(typeof $cmp3==typeof $cmp4 && ((typeof $cmp3 == 'number')||(typeof $cmp3 == 'string')||(typeof $cmp3 == 'boolean'))?
					($cmp3 == $cmp4 ? 0 : ($cmp3 < $cmp4 ? -1 : 1)):
					$p['cmp']($cmp3, $cmp4))))|1) == 1)) === null || $bool15 === false || $bool15 === 0 || $bool15 === '' ?
					false :
			...
			if ((($bool16=((((($cmp5=height)===($cmp6=0)?0:
	...
	, 1, [null,null,['self'],['styleSuffix']]);
		...
		$method = $pyjs__bind_method2('setStyleName', function(element, style, add) {
			...
			var $attr22,$bool17,$attr21;
			if ((($bool17=(style !== null)) === null || $bool17 === false || $bool17 === 0 || $bool17 === '' ?
					false :
	...
	, 1, [null,null,['self'],['element'],['style', null],['add', true]]);
		...
		$method = $pyjs__bind_method2('setStyleAttribute', function(attribute, value) {
			...
			var $bool18,el,$iter2_nextval,$iter2_type,attr,$iter2_iter,$iter2_idx,val,$iter2_array;
			if ((($bool18=(value !== null)) === null || $bool18 === false || $bool18 === 0 || $bool18 === '' ?
					false :
	...
	, 1, [null,null,['self'],['title']]);
		...
		$method = $pyjs__bind_method2('setWidth', function(width) {
			...
			var $attr25,$attr26,$bool19;
			if ((($bool19=(width === null)) === null || $bool19 === false || $bool19 === 0 || $bool19 === '' ?
					false :
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('sinkEvents', function(eventBitsToAdd) {
			...
			var $attr29,$attr30,$bool20;
			if ((($bool20=(($attr29=($attr30=self)['element']) == null || (($attr30.__is_instance__) && typeof $attr29 == 'function') || (typeof $attr29['__get__'] == 'function')?
						$p['getattr']($attr30, 'element'):
						self['element'])) === null || $bool20 === false || $bool20 === 0 || $bool20 === '' ?
					false :
	...
	, 1, [null,null,['self'],['element', null]]);
		...
		$method = $pyjs__bind_method2('getVisible', function(element) {
			...
			if (typeof element == 'undefined') element=arguments.callee.__args__[3][1];
			var $eq18,$attr34,$attr33,$pyjs_try_err,$bool21,$attr36,$attr35,$bool22,$eq17;
			if ((($bool22=!(($bool21=element) === null || $bool21 === false || $bool21 === 0 || $bool21 === '' ?
				false :
			...
			try {
				return !(($eq17=(($attr35=($attr36=element['style'])['display']) == null || (($attr36.__is_instance__) && typeof $attr35 == 'function') || (typeof $attr35['__get__'] == 'function')?
							$p['getattr']($attr36, 'display'):
							element['style']['display']))===($eq18='none')&&$eq17===null?true:
	...
	, 1, [null,null,['self'],['element', null]]);
		...
		$method = $pyjs__bind_method2('setVisible', function(element, visible) {
			...
			var $bool24,$attr37,$bool23,$attr38;
			if ((($bool23=(visible === null)) === null || $bool23 === false || $bool23 === 0 || $bool23 === '' ?
					false :
			...
			if ((($bool24=visible) === null || $bool24 === false || $bool24 === 0 || $bool24 === '' ?
					false :
