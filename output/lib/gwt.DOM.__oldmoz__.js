...
$pyjs.loaded_modules['gwt.DOM'] = function (__mod_name__) {
	...
	var $attr82,$attr81,$bool53,$bool1,$attr2,$attr1,$bool52;
	...
	$m['mash_name_for_glib'] = function(name, joiner) {
		...
		var c,$iter1_nextval,$iter1_idx,res,$iter1_iter,$add2,$add3,$add1,$add6,$iter1_array,$add4,$add5,$bool42,$iter1_type;
		res = '';
		$iter1_iter = name;
		...
		while (typeof ($iter1_nextval=($iter1_type?($iter1_type > 0?$iter1_iter.next(true,false):$p['wrapped_next']($iter1_iter)):$iter1_array[$iter1_idx++])) != 'undefined') {
			c = $iter1_nextval;
			if ((($bool42=c['isupper']()) === null || $bool42 === false || $bool42 === 0 || $bool42 === '' ?
					false :
...
element.innerHTML = html || "";
	...
	$m['setStyleAttributes'] = function(element) {
		...
		var $iter2_nextval,$iter2_type,attr,$iter2_iter,$attr76,$attr75,$iter2_idx,val,$bool43,$iter2_array;
		...
		while (typeof ($iter2_nextval=($iter2_type?($iter2_type > 0?$iter2_iter.next(true,true):$p['wrapped_next']($iter2_iter)):$iter2_array[$iter2_idx++])) != 'undefined') {
			...
			if ((($bool43=$p['hasattr']((($attr75=($attr76=element)['style']) == null || (($attr76.__is_instance__) && typeof $attr75 == 'function') || (typeof $attr75['__get__'] == 'function')?
						$p['getattr']($attr76, 'style'):
						element['style']), 'setProperty')) === null || $bool43 === false || $bool43 === 0 || $bool43 === '' ?
					false :
	...
	$m['sinkEvents'] = function(element, bits) {
		var $iter5_nextval,$iter3_type,dispEvnt,$iter5_array,$9,$iter5_iter,$iter4_type,$iter5_type,$iter4_iter,$attr80,$iter3_idx,$iter3_nextval,$attr79,$iter3_iter,$iter5_idx,$bool44,event_name,$iter3_array,bit,$14,$15,$16,$10,$11,$12,$attr78,$attr77,$iter4_nextval,$13,$iter4_idx,$iter4_array;
element.__eventBits = bits;
		...
		while (typeof ($iter3_nextval=($iter3_type?($iter3_type > 0?$iter3_iter.next(true,false):$p['wrapped_next']($iter3_iter)):$iter3_array[$iter3_idx++])) != 'undefined') {
			bit = $iter3_nextval;
			if ((($bool44=(bits)&(bit)) === null || $bool44 === false || $bool44 === 0 || $bool44 === '' ?
					false :
...
element['on'+event_name] = null
	...
	$m['previewEvent'] = function(evt) {
		var $bool47,$cmp4,$bool45,$17,$cmp3,$bool46,$18,ret,$len2,$len3,$sub2,$sub1,preview;
		ret = true;
		if ((($bool45=((($cmp3=(($len2=$m['sEventPreviewStack']) === null?0:
			...
			(typeof $cmp3==typeof $cmp4 && ((typeof $cmp3 == 'number')||(typeof $cmp3 == 'string')||(typeof $cmp3 == 'boolean'))?
				...
				$p['cmp']($cmp3, $cmp4))) == 1)) === null || $bool45 === false || $bool45 === 0 || $bool45 === '' ?
				false :
			...
			if ((($bool47=!(($bool46=ret) === null || $bool46 === false || $bool46 === 0 || $bool46 === '' ?
				false :
	...
	$m['dispatchEventImpl'] = function(event, element, listener) {
		var $eq18,$bool48,$bool49,prevCurrentEvent,$eq15,$eq16,$eq17;
		if ((($bool48=(($eq15=element)===($eq16=$m['sCaptureElem'])&&$eq15===null?true:
			($eq15===null?false:($eq16===null?false:
				((typeof $eq15=='object'||typeof $eq15=='function')&&typeof $eq15.__cmp__=='function'?$eq15.__cmp__($eq16) === 0:
					((typeof $eq16=='object'||typeof $eq16=='function')&&typeof $eq16.__cmp__=='function'?$eq16.__cmp__($eq15) === 0:
						$eq15==$eq16)))))) === null || $bool48 === false || $bool48 === 0 || $bool48 === '' ?
				false :
				(typeof $bool48=='object'?
					(typeof $bool48.__nonzero__=='function'?
						...
						(typeof $bool48.__len__=='function'?
							...
							true ) ) :
					 true ) )) {
			if ((($bool49=(($eq17=$m['eventGetType'](event))===($eq18='losecapture')&&$eq17===null?true:
	...
	$m['insertListItem'] = function(select, item, value, index) {
		var $bool50,option,$eq20,$eq19,$bool51;
		option = $m['createElement']('OPTION');
		$m['setInnerText'](option, item);
		if ((($bool50=(value !== null)) === null || $bool50 === false || $bool50 === 0 || $bool50 === '' ?
				false :
		...
		if ((($bool51=(($eq19=index)===($eq20=(typeof ($usub1=1)=='number'?
			-$usub1:
			$p['op_usub']($usub1)))&&$eq19===null?true:
			($eq19===null?false:($eq20===null?false:
				((typeof $eq19=='object'||typeof $eq19=='function')&&typeof $eq19.__cmp__=='function'?$eq19.__cmp__($eq20) === 0:
					((typeof $eq20=='object'||typeof $eq20=='function')&&typeof $eq20.__cmp__=='function'?$eq20.__cmp__($eq19) === 0:
						$eq19==$eq20)))))) === null || $bool51 === false || $bool51 === 0 || $bool51 === '' ?
				false :
	...
	if ((($bool53=!(($bool52=(($attr81=($attr82=$m['pyjd'])['is_desktop']) == null || (($attr82.__is_instance__) && typeof $attr81 == 'function') || (typeof $attr81['__get__'] == 'function')?
				$p['getattr']($attr82, 'is_desktop'):
				$m['pyjd']['is_desktop'])) === null || $bool52 === false || $bool52 === 0 || $bool52 === '' ?
		false :
