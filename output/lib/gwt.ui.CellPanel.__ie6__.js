...
$pyjs.loaded_modules['gwt.ui.CellPanel'] = function (__mod_name__) {
	...
	, 1, [null,null,['self'],['widget']]);
		...
		$method = $pyjs__bind_method2('setBorderWidth', function(width) {
			...
			var $attr23,$bool6,$attr25,$attr26,$attr24;
			if ((($bool6=(width === null)) === null || $bool6 === false || $bool6 === 0 || $bool6 === '' ?
					false :
					(typeof $bool6=='object'?
	...
	, 1, [null,null,['self'],['width']]);
		...
		$method = $pyjs__bind_method2('setCellHeight', function(widget, height) {
			...
			var td,$bool7;
			td = $m['DOM']['getParent'](widget['getElement']());
			if ((($bool7=(height === null)) === null || $bool7 === false || $bool7 === 0 || $bool7 === '' ?
					false :
					(typeof $bool7=='object'?
	...
	, 1, [null,null,['self'],['widget'],['height']]);
		...
		$method = $pyjs__bind_method2('setCellHorizontalAlignment', function(widget, align) {
			...
			var $bool8,td,$bool9;
			td = self['getWidgetTd'](widget);
			if ((($bool8=(td !== null)) === null || $bool8 === false || $bool8 === 0 || $bool8 === '' ?
					false :
					(typeof $bool8=='object'?
						(typeof $bool8.__nonzero__=='function'?
							...
							(typeof $bool8.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				if ((($bool9=(align === null)) === null || $bool9 === false || $bool9 === 0 || $bool9 === '' ?
						false :
						(typeof $bool9=='object'?
	...
	, 1, [null,null,['self'],['widget'],['align']]);
		...
		$method = $pyjs__bind_method2('setCellVerticalAlignment', function(widget, align) {
			...
			var $bool10,$bool11,td;
			td = self['getWidgetTd'](widget);
			if ((($bool10=(td !== null)) === null || $bool10 === false || $bool10 === 0 || $bool10 === '' ?
					false :
					(typeof $bool10=='object'?
						(typeof $bool10.__nonzero__=='function'?
							...
							(typeof $bool10.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				if ((($bool11=(align === null)) === null || $bool11 === false || $bool11 === 0 || $bool11 === '' ?
						false :
	...
	, 1, [null,null,['self'],['widget'],['align']]);
		...
		$method = $pyjs__bind_method2('setCellWidth', function(widget, width) {
			...
			var td,$bool12;
			td = $m['DOM']['getParent'](widget['getElement']());
			if ((($bool12=(width === null)) === null || $bool12 === false || $bool12 === 0 || $bool12 === '' ?
					false :
