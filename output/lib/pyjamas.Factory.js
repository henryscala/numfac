...
$pyjs.loaded_modules['pyjamas.Factory'] = function (__mod_name__) {
	...
	$m['createWidgetOnElement'] = function(element) {
		...
		lbr = fc['find']('(');
		klsname = $p['slice'](fc, 0, lbr);
		txtargs = $p['slice'](fc, (typeof ($add1=lbr)==typeof ($add2=1) && (typeof $add1=='number'||typeof $add1=='string')?
			$add1+$add2:
		...
		while (typeof ($iter1_nextval=($iter1_type?($iter1_type > 0?$iter1_iter.next(true,false):$p['wrapped_next']($iter1_iter)):$iter1_array[$iter1_idx++])) != 'undefined') {
			...
			if ((($bool2=(($eq1=findeq)===($eq2=(typeof ($usub2=1)=='number'?
				...
				k = $p['slice'](arg, 0, findeq);
				v = $p['slice'](arg, (typeof ($add3=findeq)==typeof ($add4=1) && (typeof $add3=='number'||typeof $add3=='string')?
					$add3+$add4:
				...
				if ((($bool6=((($bool4=$or1=((($bool3=$and1=(($eq3=(typeof ($3=v).__array != 'undefined'?
					((typeof $3.__array[$4=0]) != 'undefined'?$3.__array[$4]:
						$3.__getitem__($4)):
						$3.__getitem__(0)))===($eq4='\x27')&&$eq3===null?true:
					...
					-$usub3:
					$p['op_usub']($usub3)))))===($eq6='\x27')&&$eq5===null?true:
					...
					((typeof $7.__array[$8=0]) != 'undefined'?$7.__array[$8]:
						$7.__getitem__($8)):
						$7.__getitem__(0)))===($eq8='\x22')&&$eq7===null?true:
					...
					-$usub4:
					$p['op_usub']($usub4)))))===($eq10='\x22')&&$eq9===null?true:
						...
						(typeof $bool6=='object'?
							(typeof $bool6.__nonzero__=='function'?
								...
								(typeof $bool6.__len__=='function'?
									...
									true ) ) :
							 true ) )) {
					v = $p['slice'](v, 1, (typeof ($usub5=1)=='number'?
						-$usub5:
						$p['op_usub']($usub5)));
				}
				else {
