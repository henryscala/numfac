...
$pyjs.loaded_modules['dynamic'] = function (__mod_name__) {
	...
	$m['load'] = function(url, onreadystatechange, on_load_fn, async) {
		...
		var $or5,$bool10,$bool11,$bool12,$bool13,$bool14,$bool15,$bool16,$attr20,$or6,$eq10,$eq11,$eq12,$eq13,$eq14,$attr17,$attr16,req,$pyjs_try_err,$attr9,$or4,$eq8,$eq9,$or3,$and3,$and4,$eq7,$bool2,$attr19,$attr18,$attr15,$attr14,$bool8,$bool9,$attr11,$attr10,$attr13,$attr12,$add2,$add1;
		;
		...
		if ((($bool2=(onreadystatechange === null)) === null || $bool2 === false || $bool2 === 0 || $bool2 === '' ?
			...
			onreadystatechange = function(evnt) {
				var $eq6,$eq2,$eq3,$attr3,$attr8,$attr2,$or1,$add4,$or2,$attr1,$and1,$and2,$eq1,$attr5,$attr4,$eq4,$attr6,$bool3,$bool6,$attr7,$bool4,$bool5,$eq5,$add3,str,$bool7;
				if ((($bool5=((($bool3=$and1=(($eq1=(($attr1=($attr2=req)['readyState']) == null || (($attr2.__is_instance__) && typeof $attr1 == 'function') || (typeof $attr1['__get__'] == 'function')?
							$p['getattr']($attr2, 'readyState'):
							req['readyState']))===($eq2=4)&&$eq1===null?true:
						...
						(typeof $bool3.__nonzero__=='function'?
							...
							(typeof $bool3.__len__=='function'?
								($bool3.__len__()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?((($bool4=$or1=(($eq3=(($attr3=($attr4=req)['status']) == null || (($attr4.__is_instance__) && typeof $attr3 == 'function') || (typeof $attr3['__get__'] == 'function')?
							$p['getattr']($attr4, 'status'):
							req['status']))===($eq4=200)&&$eq3===null?true:
						...
						(typeof $bool4.__nonzero__=='function'?
							...
							(typeof $bool4.__len__=='function'?
								($bool4.__len__()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?$or1:(($eq5=(($attr5=($attr6=req)['status']) == null || (($attr6.__is_instance__) && typeof $attr5 == 'function') || (typeof $attr5['__get__'] == 'function')?
							$p['getattr']($attr6, 'status'):
							req['status']))===($eq6=0)&&$eq5===null?true:
...
req.onreadystatechange = onreadystatechange;
		...
		try {
			...
			while ((($bool9=true) === null || $bool9 === false || $bool9 === 0 || $bool9 === '' ?
					...
					(typeof $bool9=='object'?
						(typeof $bool9.__nonzero__=='function'?
							...
							(typeof $bool9.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				if ((($bool12=((($bool10=$or3=(($eq7=(($attr9=($attr10=req)['status']) == null || (($attr10.__is_instance__) && typeof $attr9 == 'function') || (typeof $attr9['__get__'] == 'function')?
							$p['getattr']($attr10, 'status'):
							req['status']))===($eq8=200)&&$eq7===null?true:
						...
						(typeof $bool10.__nonzero__=='function'?
							...
							(typeof $bool10.__len__=='function'?
								($bool10.__len__()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?$or3:((($bool11=$and3=(($eq9=(($attr11=($attr12=req)['status']) == null || (($attr12.__is_instance__) && typeof $attr11 == 'function') || (typeof $attr11['__get__'] == 'function')?
							$p['getattr']($attr12, 'status'):
							req['status']))===($eq10=0)&&$eq9===null?true:
						...
						(typeof $bool11.__nonzero__=='function'?
							...
							(typeof $bool11.__len__=='function'?
								($bool11.__len__()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?(($attr13=($attr14=req)['responseText']) == null || (($attr14.__is_instance__) && typeof $attr13 == 'function') || (typeof $attr13['__get__'] == 'function')?
							$p['getattr']($attr14, 'responseText'):
							req['responseText']):$and3))) === null || $bool12 === false || $bool12 === 0 || $bool12 === '' ?
						false :
				...
				if ((($bool16=((($bool15=$or5=!(($eq11=(($attr15=($attr16=req)['status']) == null || (($attr16.__is_instance__) && typeof $attr15 == 'function') || (typeof $attr15['__get__'] == 'function')?
							$p['getattr']($attr16, 'status'):
							req['status']))===($eq12=0)&&$eq11===null?true:
						...
						(typeof $bool15.__nonzero__=='function'?
							...
							(typeof $bool15.__len__=='function'?
								($bool15.__len__()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?$or5:!(($eq13=(($attr17=($attr18=req)['responseText']) == null || (($attr18.__is_instance__) && typeof $attr17 == 'function') || (typeof $attr17['__get__'] == 'function')?
							$p['getattr']($attr18, 'responseText'):
							req['responseText']))===($eq14='')&&$eq13===null?true:
...
namespace[k] = v;
	...
	$m['activate_css'] = function(targetnode) {
		var $bool19,$iter3_idx,LC,$iter3_type,$attr21,$iter3_nextval,scriptnodes,$attr23,$attr22,$len1,$attr24,$iter3_iter,$iter3_array,$6,fileref,$5,sn;
	...
	$m['ajax_eval'] = function(url, on_load_fn, async) {
		...
		onready = function(evnt, req) {
			var $attr26,$bool21,$bool20,str,$attr25;
	...
	$m['ajax_import'] = function(url, namespace, names) {
		if (typeof namespace == 'undefined') namespace=arguments.callee.__args__[3][1];
		if (typeof names == 'undefined') names=arguments.callee.__args__[4][1];
		var module,$iter4_type,$attr27,$attr28,$attr29,$iter4_iter,script,req,$pyjs_try_err,$bool23,$bool22,$attr30,$8,$7,e,name,$iter4_nextval,$iter4_idx,name_getter,$iter4_array;
		;
	...
	$m['ajax_dlink'] = function(idname, url, on_load_fn) {
		var body,$attr32,$attr31,xhtoj,$bool28,onreadystatechange;
		...
		onreadystatechange = function() {
			var $eq18,$eq19,$attr40,txt,$eq17,$bool29,jsnode,$attr33,$eq20,$attr37,$attr36,$attr35,$attr34,$attr39,$attr38,$bool32,$bool33,$bool30,$bool31,$bool36,$bool34,$bool35;
			if ((($bool29=(($eq17=(($attr33=($attr34=$m.xhtoj)['readyState']) == null || (($attr34.__is_instance__) && typeof $attr33 == 'function') || (typeof $attr33['__get__'] == 'function')?
						$p['getattr']($attr34, 'readyState'):
						$m.xhtoj['readyState']))===($eq18=4)&&$eq17===null?true:
				($eq17===null?false:($eq18===null?false:
					...
					(typeof $bool29=='object'?
						(typeof $bool29.__nonzero__=='function'?
						 ...
						 true ) )) {
				jsnode = 0;
				if ((($bool30=(($eq19=(($attr35=($attr36=$m.xhtoj)['status']) == null || (($attr36.__is_instance__) && typeof $attr35 == 'function') || (typeof $attr35['__get__'] == 'function')?
							$p['getattr']($attr36, 'status'):
							$m.xhtoj['status']))===($eq20=200)&&$eq19===null?true:
