...
$pyjs.loaded_modules['gwt.Window'] = function (__mod_name__) {
	...
	$m['getDocumentRoot'] = function() {
		var $attr9,$attr8,$eq2,$eq1,$attr5,$attr7,$attr6,$bool7,$attr10;
		if ((($bool7=(($eq1=(($attr5=($attr6=$doc)['compatMode']) == null || (($attr6.__is_instance__) && typeof $attr5 == 'function') || (typeof $attr5['__get__'] == 'function')?
