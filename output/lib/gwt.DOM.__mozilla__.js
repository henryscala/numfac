...
$pyjs.loaded_modules['gwt.DOM'] = function (__mod_name__) {
	...
	var $attr82,$attr81,$bool53,$bool1,$attr2,$attr1,$bool54;
	...
	$m['eventGetType'] = function(event) {
		var $attr33,$bool30,$attr34,etype,$eq15,$eq16;
		etype = (($attr33=($attr34=event)['type']) == null || (($attr34.__is_instance__) && typeof $attr33 == 'function') || (typeof $attr33['__get__'] == 'function')?
					$p['getattr']($attr34, 'type'):
					event['type']);
		if ((($bool30=(($eq15=etype)===($eq16='DOMMouseScroll')&&$eq15===null?true:
	...
	, 1, [null,null,['self'],['elem']]);
		...
		$method = $pyjs__bind_method2('next', function() {
			...
			var $attr50,$attr46,$attr47,$attr44,$attr45,$bool36,$attr43,$bool35,$attr48,$attr49;
			if ((($bool36=!(($bool35=(($attr43=($attr44=self)['child']) == null || (($attr44.__is_instance__) && typeof $attr43 == 'function') || (typeof $attr43['__get__'] == 'function')?
	...
	, 1, [null,null,['self'],['elem']]);
		...
		$method = $pyjs__bind_method2('next', function() {
			...
			var nextSibling,firstChild,$attr68,$attr64,$attr65,$attr67,$attr60,$attr61,$attr62,$attr63,$bool42,$bool41,$bool40,$attr59,$attr58,$cmp1,$cmp2,$attr53,$attr55,$attr54,$attr57,$attr56,$bool37,$len1,$bool38,$bool39,$attr66;
			if ((($bool38=!(($bool37=(($attr53=($attr54=self)['child']) == null || (($attr54.__is_instance__) && typeof $attr53 == 'function') || (typeof $attr53['__get__'] == 'function')?
			...
			else if ((($bool42=((($cmp1=(($len1=(($attr65=($attr66=self)['stack']) == null || (($attr66.__is_instance__) && typeof $attr65 == 'function') || (typeof $attr65['__get__'] == 'function')?
	...
	$m['mash_name_for_glib'] = function(name, joiner) {
		...
		var c,$iter1_nextval,$iter1_idx,res,$iter1_iter,$add2,$add3,$add1,$add6,$iter1_array,$add4,$add5,$bool43,$iter1_type;
		res = '';
		$iter1_iter = name;
		...
		while (typeof ($iter1_nextval=($iter1_type?($iter1_type > 0?$iter1_iter.next(true,false):$p['wrapped_next']($iter1_iter)):$iter1_array[$iter1_idx++])) != 'undefined') {
			c = $iter1_nextval;
			if ((($bool43=c['isupper']()) === null || $bool43 === false || $bool43 === 0 || $bool43 === '' ?
					false :
...
element.innerHTML = html || "";
	...
	$m['setStyleAttributes'] = function(element) {
		...
		var $iter2_nextval,$iter2_type,attr,$iter2_iter,$attr76,$attr75,$iter2_idx,val,$bool44,$iter2_array;
		...
		while (typeof ($iter2_nextval=($iter2_type?($iter2_type > 0?$iter2_iter.next(true,true):$p['wrapped_next']($iter2_iter)):$iter2_array[$iter2_idx++])) != 'undefined') {
			...
			if ((($bool44=$p['hasattr']((($attr75=($attr76=element)['style']) == null || (($attr76.__is_instance__) && typeof $attr75 == 'function') || (typeof $attr75['__get__'] == 'function')?
						$p['getattr']($attr76, 'style'):
						element['style']), 'setProperty')) === null || $bool44 === false || $bool44 === 0 || $bool44 === '' ?
					false :
	...
	$m['sinkEvents'] = function(element, bits) {
		var $iter5_nextval,$iter3_type,dispEvnt,$iter5_array,$9,$iter5_iter,$iter4_type,$iter5_type,$iter4_iter,$attr80,$iter3_idx,$iter3_nextval,$attr79,$iter3_iter,$iter5_idx,$bool45,event_name,$iter3_array,bit,$14,$15,$16,$10,$11,$12,$attr78,$attr77,$iter4_nextval,$13,$iter4_idx,$iter4_array;
element.__eventBits = bits;
		...
		while (typeof ($iter3_nextval=($iter3_type?($iter3_type > 0?$iter3_iter.next(true,false):$p['wrapped_next']($iter3_iter)):$iter3_array[$iter3_idx++])) != 'undefined') {
			bit = $iter3_nextval;
			if ((($bool45=(bits)&(bit)) === null || $bool45 === false || $bool45 === 0 || $bool45 === '' ?
					false :
					(typeof $bool45=='object'?
						(typeof $bool45.__nonzero__=='function'?
							...
							(typeof $bool45.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				$iter4_iter = (typeof ($11=(typeof ($9=(($attr77=($attr78=$m['Event'])['eventbits']) == null || (($attr78.__is_instance__) && typeof $attr77 == 'function') || (typeof $attr77['__get__'] == 'function')?
...
element['on'+event_name] = dispEvnt
				...
				$iter5_iter = (typeof ($15=(typeof ($13=(($attr79=($attr80=$m['Event'])['eventbits']) == null || (($attr80.__is_instance__) && typeof $attr79 == 'function') || (typeof $attr79['__get__'] == 'function')?
							$p['getattr']($attr80, 'eventbits'):
							$m['Event']['eventbits'])).__array != 'undefined'?
...
element['on'+event_name] = null
	...
	$m['previewEvent'] = function(evt) {
		var $bool47,$bool46,$17,$cmp3,$cmp4,$18,ret,$bool48,$len2,$len3,$sub2,$sub1,preview;
		ret = true;
		if ((($bool46=((($cmp3=(($len2=$m['sEventPreviewStack']) === null?0:
			...
			(typeof $cmp3==typeof $cmp4 && ((typeof $cmp3 == 'number')||(typeof $cmp3 == 'string')||(typeof $cmp3 == 'boolean'))?
				...
				$p['cmp']($cmp3, $cmp4))) == 1)) === null || $bool46 === false || $bool46 === 0 || $bool46 === '' ?
				false :
			...
			if ((($bool48=!(($bool47=ret) === null || $bool47 === false || $bool47 === 0 || $bool47 === '' ?
				false :
	...
	$m['dispatchEventImpl'] = function(event, element, listener) {
		var $eq18,$bool50,$eq20,$bool49,$eq19,prevCurrentEvent,$eq17;
		if ((($bool49=(($eq17=element)===($eq18=$m['sCaptureElem'])&&$eq17===null?true:
			($eq17===null?false:($eq18===null?false:
				((typeof $eq17=='object'||typeof $eq17=='function')&&typeof $eq17.__cmp__=='function'?$eq17.__cmp__($eq18) === 0:
					((typeof $eq18=='object'||typeof $eq18=='function')&&typeof $eq18.__cmp__=='function'?$eq18.__cmp__($eq17) === 0:
						$eq17==$eq18)))))) === null || $bool49 === false || $bool49 === 0 || $bool49 === '' ?
				false :
				(typeof $bool49=='object'?
					(typeof $bool49.__nonzero__=='function'?
						...
						(typeof $bool49.__len__=='function'?
							...
							true ) ) :
					 true ) )) {
			if ((($bool50=(($eq19=$m['eventGetType'](event))===($eq20='losecapture')&&$eq19===null?true:
				($eq19===null?false:($eq20===null?false:
					((typeof $eq19=='object'||typeof $eq19=='function')&&typeof $eq19.__cmp__=='function'?$eq19.__cmp__($eq20) === 0:
						((typeof $eq20=='object'||typeof $eq20=='function')&&typeof $eq20.__cmp__=='function'?$eq20.__cmp__($eq19) === 0:
							$eq19==$eq20)))))) === null || $bool50 === false || $bool50 === 0 || $bool50 === '' ?
					false :
	...
	$m['insertListItem'] = function(select, item, value, index) {
		var option,$bool52,$eq21,$eq22,$bool51;
		option = $m['createElement']('OPTION');
		$m['setInnerText'](option, item);
		if ((($bool51=(value !== null)) === null || $bool51 === false || $bool51 === 0 || $bool51 === '' ?
				false :
		...
		if ((($bool52=(($eq21=index)===($eq22=(typeof ($usub1=1)=='number'?
			-$usub1:
			...
			($eq21===null?false:($eq22===null?false:
				((typeof $eq21=='object'||typeof $eq21=='function')&&typeof $eq21.__cmp__=='function'?$eq21.__cmp__($eq22) === 0:
					((typeof $eq22=='object'||typeof $eq22=='function')&&typeof $eq22.__cmp__=='function'?$eq22.__cmp__($eq21) === 0:
						$eq21==$eq22)))))) === null || $bool52 === false || $bool52 === 0 || $bool52 === '' ?
				false :
	...
	if ((($bool54=!(($bool53=(($attr81=($attr82=$m['pyjd'])['is_desktop']) == null || (($attr82.__is_instance__) && typeof $attr81 == 'function') || (typeof $attr81['__get__'] == 'function')?
				$p['getattr']($attr82, 'is_desktop'):
